...
| `project` | `{ repository?: string \| undefined; homepage?: string \| undefined; packageName?: string \| undefined; }` | No | Project metadata — auto-detected from package.json if not provided. |
