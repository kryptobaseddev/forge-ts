...
| Name    | Type     | Description             |
| ------- | -------- | ----------------------- |
| `value` | `string` | The plain text content. |
...
| Name   | Type     | Description                                 |
| ------ | -------- | ------------------------------------------- |
| `bold` | `string` | Text to render in bold at the start.        |
| `rest` | `string` | Plain text appended after the bold segment. |
...
| Name    | Type     | Description                              |
| ------- | -------- | ---------------------------------------- |
| `value` | `string` | The plain text content of the list item. |
...
| Name       | Type     | Description                                             |
| ---------- | -------- | ------------------------------------------------------- |
| `markdown` | `string` | The raw markdown/HTML string to pass through unescaped. |
...
| `maxLen` | `: number` | Maximum allowed length (including the trailing `...`). |
...
| Name   | Type     | Description                           |
| ------ | -------- | ------------------------------------- |
| `text` | `string` | The heading or label text to slugify. |
...
| Name   | Type     | Description                                                  |
| ------ | -------- | ------------------------------------------------------------ |
| `path` | `string` | The relative file path (e.g., `"./packages/core/index.md"`). |
...
| Name      | Type            | Description                                 |
| --------- | --------------- | ------------------------------------------- |
| `symbols` | `ForgeSymbol[]` | All symbols extracted from the project.     |
...
| --------- | ------------------- | -------------------------------------------------- |
| `config`  | `ForgeConfig`       | The resolved `ForgeConfig` for the project.        |
| `options` | `: GenerateOptions` | Optional generation flags (see `GenerateOptions`). |
