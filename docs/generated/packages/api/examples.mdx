...
[View in API reference](/packages/api/api-reference#signaturetoschema)
...
[View in API reference](/packages/api/api-reference#extractsdktypes)
...
[View in API reference](/packages/api/api-reference#generateopenapispec)
...
[View in API reference](/packages/api/api-reference#buildreference)
...
[View in API reference](/packages/api/api-reference#generateapi)
