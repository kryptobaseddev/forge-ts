...
[View in API reference](/packages/cli/api-reference#emitresult)
...
[View in API reference](/packages/cli/api-reference#runbuild)
...
[View in API reference](/packages/cli/api-reference#runcheck)
...
[View in API reference](/packages/cli/api-reference#rundocsdev)
...
[View in API reference](/packages/cli/api-reference#docsdevcommand)
...
[View in API reference](/packages/cli/api-reference#initdocsresult)
...
[View in API reference](/packages/cli/api-reference#runinitdocs)
...
[View in API reference](/packages/cli/api-reference#initdocscommand)
...
[View in API reference](/packages/cli/api-reference#initcommand)
...
[View in API reference](/packages/cli/api-reference#runtest)
