...
[View in API reference](/packages/gen/api-reference#groupsymbolsbypackage)
...
[View in API reference](/packages/gen/api-reference#generatedocsite)
...
[View in API reference](/packages/gen/api-reference#ssgadapter)
...
[View in API reference](/packages/gen/api-reference#registeradapter)
...
[View in API reference](/packages/gen/api-reference#getadapter)
...
[View in API reference](/packages/gen/api-reference#getavailabletargets)
...
[View in API reference](/packages/gen/api-reference#mintlifyadapter)
...
[View in API reference](/packages/gen/api-reference#docusaurusadapter)
...
[View in API reference](/packages/gen/api-reference#nextraadapter)
...
[View in API reference](/packages/gen/api-reference#vitepressadapter)
...
[View in API reference](/packages/gen/api-reference#generatellmstxt)
...
[View in API reference](/packages/gen/api-reference#generatellmsfulltxt)
...
[View in API reference](/packages/gen/api-reference#generatemarkdown)
...
[View in API reference](/packages/gen/api-reference#syncreadme)
...
[View in API reference](/packages/gen/api-reference#generatessgconfigs)
...
[View in API reference](/packages/gen/api-reference#generate)
