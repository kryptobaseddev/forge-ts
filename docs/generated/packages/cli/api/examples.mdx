...
[View in API reference](/packages/cli/api/functions#runbarometer)
...
[View in API reference](/packages/cli/api/functions#runbarometerscore)
...
[View in API reference](/packages/cli/api/functions#barometercommand)
