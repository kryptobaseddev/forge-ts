...
*TSDoc enforcement engine for TypeScript projects.  Walks all exported symbols and applies up to 40 configurable rules that verify documentation completeness, correctness, and freshness. Rules are split into 20 error-level codes (E001–E020) and 20 warning-level codes (W001–W020), covering summaries, parameters, return types, examples, release tags, staleness detection, and CKM truthfulness.*

[View in API reference](/packages/enforcer/reference/functions#indexts)
