...
_Generates a `skill.md` file that teaches AI assistants about the project.  The file contains: - Project overview and purpose - Installation instructions - Key concepts and types - Common usage patterns (from_
