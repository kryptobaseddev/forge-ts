 ...
 *
 * @remarks
 * Uses the walker's `links` metadata to detect cross-package references to symbols
 * that carry a `@deprecated` tag, comparing file paths to determine package boundaries.
 *
