...
[View in API reference](/packages/gen/api/functions#ckmconcept)
...
[View in API reference](/packages/gen/api/functions#ckmoperation)
...
[View in API reference](/packages/gen/api/functions#ckmconstraint)
...
[View in API reference](/packages/gen/api/functions#ckmworkflow)
...
[View in API reference](/packages/gen/api/functions#ckmmanifest)
