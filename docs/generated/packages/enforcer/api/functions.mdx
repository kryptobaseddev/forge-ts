...
|------|------|-------------|
| `symbols` | `ForgeSymbol[]` | All symbols from the walker across the entire project. |
...
| Name | Type | Description |
|------|------|-------------|
| `result` | `ForgeResult` | The result produced by . |
| `options` | `FormatOptions` | Rendering options (colours, verbosity). |
