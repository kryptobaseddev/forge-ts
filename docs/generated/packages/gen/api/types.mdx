...
| Property   | Type           | Required | Description |
| ---------- | -------------- | -------- | ----------- |
| `type`     | `"strong"`     | Yes      | type        |
| `children` | `MdPhrasing[]` | Yes      | children    |
...
| Property   | Type                         | Required | Description |
| ---------- | ---------------------------- | -------- | ----------- |
| `type`     | `"heading"`                  | Yes      | type        |
| `depth`    | `1 \| 2 \| 3 \| 4 \| 5 \| 6` | Yes      | depth       |
| `children` | `MdPhrasing[]`               | Yes      | children    |
...
| -------- | ----------------------------- | -------- | ----------- |
| `type`   | `"code"`                      | Yes      | type        |
| `lang`   | `string \| null \| undefined` | No       | lang        |
| `value`  | `string`                      | Yes      | value       |
...
| Property   | Type           | Required | Description |
| ---------- | -------------- | -------- | ----------- |
| `type`     | `"blockquote"` | Yes      | type        |
| `children` | `MdBlock[]`    | Yes      | children    |
...
| Property   | Type                   | Required | Description |
| ---------- | ---------------------- | -------- | ----------- |
| `type`     | `"listItem"`           | Yes      | type        |
| `spread`   | `boolean \| undefined` | No       | spread      |
| `children` | `MdBlock[]`            | Yes      | children    |
...
| ---------- | ---------------------- | -------- | ----------- |
| `type`     | `"list"`               | Yes      | type        |
| `ordered`  | `boolean \| undefined` | No       | ordered     |
| `spread`   | `boolean \| undefined` | No       | spread      |
| `children` | `MdListItem[]`         | Yes      | children    |
...
| Property   | Type            | Required | Description |
| ---------- | --------------- | -------- | ----------- |
| `type`     | `"tableRow"`    | Yes      | type        |
| `children` | `MdTableCell[]` | Yes      | children    |
...
| ---------- | -------------------------------------------------------- | -------- | ----------- |
| `type`     | `"table"`                                                | Yes      | type        |
| `align`    | `("left" \| "center" \| "right" \| null)[] \| undefined` | No       | align       |
| `children` | `MdTableRow[]`                                           | Yes      | children    |
