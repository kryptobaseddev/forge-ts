 ...
 *
 * @remarks
 * Filters the symbol list to exported interfaces, type aliases, classes, and enums,
 * then maps each to an `SDKType` with extracted properties from child symbols.
 *
