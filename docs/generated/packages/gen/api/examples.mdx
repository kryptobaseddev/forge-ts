...
_Mintlify SSG adapter. Implements the `SSGAdapter` contract for the Mintlify platform._
...
_Docusaurus SSG adapter. Implements the `SSGAdapter` contract for the Docusaurus platform._
...
_Nextra SSG adapter (v4, App Router). Implements the `SSGAdapter` contract for the Nextra platform._
...
_VitePress SSG adapter. Implements the `SSGAdapter` contract for the VitePress platform._
