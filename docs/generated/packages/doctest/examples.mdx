...
[View in API reference](/packages/doctest/api-reference#extractexamples)
...
[View in API reference](/packages/doctest/api-reference#generatetestfiles)
...
[View in API reference](/packages/doctest/api-reference#runtests)
...
[View in API reference](/packages/doctest/api-reference#doctest)
