...
[View in API reference](/packages/gen/reference/functions#discoverguides)
...
[View in API reference](/packages/gen/reference/functions#serializemarkdown)
...
[View in API reference](/packages/gen/reference/functions#textp)
...
[View in API reference](/packages/gen/reference/functions#boldintrop)
...
[View in API reference](/packages/gen/reference/functions#textlistitem)
...
[View in API reference](/packages/gen/reference/functions#rawblock)
...
[View in API reference](/packages/gen/reference/functions#truncate)
...
[View in API reference](/packages/gen/reference/functions#toanchor)
...
[View in API reference](/packages/gen/reference/functions#sluglink)
...
[View in API reference](/packages/gen/reference/functions#parsefrontmatter)
...
[View in API reference](/packages/gen/reference/functions#stringifywithfrontmatter)
...
[View in API reference](/packages/gen/reference/functions#stripfrontmatter)
...
[View in API reference](/packages/gen/reference/functions#parseinline)
...
[View in API reference](/packages/gen/reference/functions#parseblocks)
...
[View in API reference](/packages/gen/reference/functions#sanitizeformdx)
...
[View in API reference](/packages/gen/reference/functions#isstubmodified)
...
[View in API reference](/packages/gen/reference/functions#updatestubsections)
...
[View in API reference](/packages/gen/reference/functions#escapemdx)
...
[View in API reference](/packages/gen/reference/functions#groupsymbolsbypackage)
...
[View in API reference](/packages/gen/reference/functions#generatedocsite)
...
[View in API reference](/packages/gen/reference/functions#ssgadapter)
...
[View in API reference](/packages/gen/reference/functions#registeradapter)
...
[View in API reference](/packages/gen/reference/functions#getadapter)
...
[View in API reference](/packages/gen/reference/functions#getavailabletargets)
...
[View in API reference](/packages/gen/reference/functions#mintlifyadapter)
...
[View in API reference](/packages/gen/reference/functions#docusaurusadapter)
...
[View in API reference](/packages/gen/reference/functions#nextraadapter)
...
[View in API reference](/packages/gen/reference/functions#vitepressadapter)
...
[View in API reference](/packages/gen/reference/functions#fumadocsadapter)
...
[View in API reference](/packages/gen/reference/functions#generateckm)
...
[View in API reference](/packages/gen/reference/functions#generatellmstxt)
...
[View in API reference](/packages/gen/reference/functions#generatellmsfulltxt)
...
[View in API reference](/packages/gen/reference/functions#generatemarkdown)
...
[View in API reference](/packages/gen/reference/functions#syncreadme)
...
[View in API reference](/packages/gen/reference/functions#generateskillpackage)
...
[View in API reference](/packages/gen/reference/functions#generateskillmd)
...
[View in API reference](/packages/gen/reference/functions#generatessgconfigs)
...
[View in API reference](/packages/gen/reference/functions#generate)
...
*Documentation generation pipeline for the forge-ts toolchain.  Converts the `ForgeSymbol[]` graph produced by `@forge-ts/core` into human- and machine-readable output: multi-page Markdown or MDX site files, `llms.txt` / `llms-full.txt` LLM-context companions, a Codebase Knowledge Manifest (`ckm.json`), SKILL.md agent skill packages, and OpenAPI-compatible site scaffolding for Docusaurus, Mintlify, Nextra, VitePress, and Fumadocs.*

[View in API reference](/packages/gen/reference/functions#indexts)
