...
| `"require-remarks"`              | `RuleSeverity` | Yes      | E013: Exported function/class is missing a                                               |
| `"require-default-value"`        | `RuleSeverity` | Yes      | E014: Optional property with default is missing defaultValue.                            |
| `"require-type-param"`           | `RuleSeverity` | Yes      | E015: Generic symbol is missing                                                          |
| `"require-see"`                  | `RuleSeverity` | Yes      | W005: Symbol references other symbols via  but has no                                    |
...
| `"require-internal-boundary"`    | `RuleSeverity` | Yes      | E017:  symbol re-exported through public barrel (index.ts).                              |
| `"require-route-response"`       | `RuleSeverity` | Yes      | E018: route-tagged function missing                                                      |
| `"require-inheritdoc-source"`    | `RuleSeverity` | Yes      | W009:  references a symbol that does not exist.                                          |
| `"require-migration-path"`       | `RuleSeverity` | Yes      | W010:                                                                                    |
| `"require-since"`                | `RuleSeverity` | Yes      | W011: New public export missing                                                          |
| `"require-fresh-examples"`       | `RuleSeverity` | Yes      | W013:                                                                                    |
...
| `"require-fresh-link-text"`      | `RuleSeverity` | Yes      | W012:  display text appears stale relative to target summary.                            |
