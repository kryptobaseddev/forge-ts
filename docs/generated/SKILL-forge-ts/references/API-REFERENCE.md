...
- `"require-operation-completeness"` — W018: `\@operation`-tagged function missing required CKM documentation (`\@param`, `\@returns`, `\@remarks`, `\@example`).
- `"require-ckm-tag-content"` — W019: CKM tag (`\@operation`, `\@constraint`, `\@workflow`, `\@concept`) has empty or insufficient content.
- `"require-constraint-throws"` — W020: `\@constraint`-tagged symbol missing `\@throws` to document constraint violation error.
